...
def train_opt(args, seed):
    ...
    with open("./reporting/" + "new_sgd_no_momentum_c_" + str(args.c) + "_p_" + str(args.p) + "_graph_" + args.graph_mode + "_dataset_" +
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if max_test_acc < test_acc:
                ...
                if not os.path.isdir('checkpoint'):
                    os.mkdir('checkpoint')
                filename = "new_sgd_no_momentum_c_" + str(args.c) + "_p_" + str(args.p) + "_graph_" + args.graph_mode \
